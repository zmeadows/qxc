...
#define DECL_HASH_TABLE(NEW_TYPE, KEY_TYPE, VALUE_TYPE)                                  \
    struct NEW_TYPE {                                                                    \
        KEY_TYPE* keys;                                                                  \
        VALUE_TYPE* values;                                                              \
        size_t count;                                                                    \
    ...
    void NEW_TYPE##__insert(struct NEW_TYPE* table, KEY_TYPE new_id, KEY_VALUE new_val); \
...
#define IMPL_HASH_TABLE(NEW_TYPE, KEY_TYPE, VALUE_TYPE, HASH_FUNC, EQU_FUNC,           \
                        SWAP_KEYS_FUNC, SWAP_VALS_FUNC, EMPTY_SENTINEL,                \
                        TOMBSTONE_SENTINEL)                                            \
